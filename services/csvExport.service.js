  ...
  sendCsvFile(res, order.name, [
    {
      ...
      rows: pairRows({
        ...
        progress: `${Number(order.progressPercentage || 0)}%`,
        implantSystem: order.implantSystem,
        implantSystemOther: order.implantSystemOther,
        servicesNeeded: (order.servicesNeeded || []).join(", "),
        servicesNeededOther: order.servicesNeededOther,
