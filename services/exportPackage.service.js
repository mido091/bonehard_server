    ...
    sections: [
      {
        title: "Case Summary",
        rows: [
          { label: "Status", value: item.statusName || "Order Received" },
          { label: "Progress", value: `${Number(item.progressPercentage || 0)}%` },
          { label: "Implant System", value: item.implantSystem },
          { label: "Implant System Details", value: item.implantSystemOther },
          { label: "Services Needed", value: (item.servicesNeeded || []).join(", ") },
          { label: "Services Details", value: item.servicesNeededOther },
    ...
    sections: [
      {
        ...
        rows: [
          ...
          { label: "Progress", value: `${Number(order.progressPercentage || 0)}%` },
          { label: "Implant System", value: order.implantSystem },
          { label: "Implant System Details", value: order.implantSystemOther },
          { label: "Services Needed", value: (order.servicesNeeded || []).join(", ") },
          { label: "Services Details", value: order.servicesNeededOther },
